...
def clear_y_V(y_test, guassian_filter : bool = True, normalization : str = 'MinMax', fluo_filter_bool : bool = False):
    if fluo_filter_bool:
        y_test = fluo_filter(y_test)
...
def pre_elaboration_V(x_1_i : list, y_1_i : list, x_2_i : list, y_2_i : list, divdelta : float = 1, filter : bool = True, norm : str = 'Stat', min_max : list = [None,None], exclusion_zone : list = [None,None], fluo_filter_bool : bool = False):
    ...
    y_1 = clear_y_V(y_1, filter, normalization = norm, fluo_filter_bool = fluo_filter_bool)
    y_2 = clear_y_V(y_2, filter, normalization = norm, fluo_filter_bool = fluo_filter_bool)
    y_1, y_2, x_1, x_2 = same_x_projection(x_1, y_1, x_2, y_2, divdelta)
    return x_1, y_1, x_2, y_2